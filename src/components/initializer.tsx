...
export class Initializer extends React.Component<Props, State> {
  ...
  render() {
    ...
    const operationsPending =
      enablingApis || creatingGcsBucket || creatingCloudFunction;
    return (
      <div className={css.column}>
        <p>
          ...
          Function used by the Scheduler must be deployed in your project. These
          services may incur additional charges when used. By clicking{' '}
          <em>Initialize</em>, you are agreeing to the terms of service for the
          various APIs and charges in use.
        </p>
        ...
        {projectState && (
          <div className={css.actionBar}>
            ...
            <SubmitButton
              actionPending={operationsPending}
  ...
  private async _createGcsBucket() {
    ...
    try {
      await this.props.gcpService.createBucket(
        this.state.projectState.projectId
      );
    } catch (err) {
